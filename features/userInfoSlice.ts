...
import { Info, ExperienceType, SkillType, eduType } from "../types";
interface State {
  storeInfo: Info;
...
const initialState: State = {
  storeInfo:
    typeof window !== "undefined" && localStorage.getItem("personalInfo")
      ? JSON.parse(localStorage.getItem("personalInfo") || "{}")
      : {},
  summary:
    typeof window !== "undefined" && localStorage.getItem("summary")
      ? JSON.parse(localStorage.getItem("summary") || "")
      : "",
  experience:
    typeof window !== "undefined" && localStorage.getItem("experience")
  ...
  education:
    typeof window !== "undefined" && localStorage.getItem("education")
  ...
  skill:
    typeof window !== "undefined" && localStorage.getItem("skill")
